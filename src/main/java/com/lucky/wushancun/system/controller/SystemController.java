...
public class SystemController extends BaseController{
    ...
    @RequestMapping(value = "form-line",method = {RequestMethod.GET,RequestMethod.POST})
    public String formline(Model model,HttpServletRequest request,HttpServletResponse response){
        return viewPath.concat("form-line");
    }
}
